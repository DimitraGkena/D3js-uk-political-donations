...
var brake = 0.2;
var sound = new Audio("sound.mp3"); // vazw ixo 
...
var fill2 = d3.scale.ordinal().range(["#FF4500", "#23FE18", "#B0C4DE", "#BE52B8","#800000"]);
...
function start() {
	...
	.enter().append("circle")
		...
		/* .on("click", function() { window.open('http://www.google.com/search?q=' + d.donor)});
		     h parapanw entoli afora sthn anazitisi google */
